      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="center" colspan="8">
            ...
            <!-- <el-input class="line" style="width: 70px"></el-input>年<el-input class="line" style="width: 70px"></el-input> 月<el-input
              class="line"
              style="width: 70px"
            ></el-input>
            日 &nbsp;&nbsp;&nbsp;至 <el-input class="line" style="width: 70px"></el-input>年<el-input
              class="line"
              style="width: 70px"
            ></el-input>
            月<el-input class="line" style="width: 70px"></el-input>
            日 -->
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="center" rowspan="5" colspan="2">出勤考核</td>
          <td class="left" colspan="6">
          ...
          <td class="center" rowspan="5">依据合同条款执行</td>
        </tr>
        <tr>
          <td class="left" colspan="6">
            2、本月出勤迟到或早退超过15分钟及以上<el-input
              class="line"
              style="width: 100px"
              v-model.number="dataval[17]"
            />起，每人次扣除服务费100元；
          </td>
        ...
        <tr>
          <td class="left" colspan="6">
            3、本月未事先请假，旷工或迟到、早退超过30分钟及以上<el-input
              class="line"
              style="width: 100px"
              v-model.number="dataval[19]"
            />起，每人次扣除服务费500元
          </td>
        ...
        <tr>
          <td class="left" colspan="6">
            4、本月当天缺勤人数超过应出勤人数30%及以上<el-input
              class="line"
              style="width: 100px"
              v-model.number="dataval[21]"
            />起，扣除服务费5000元。
          </td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[22]" /></td>
        </tr>
        <tr>
          <td class="left" colspan="6">
            5、本月存在考勤作弊<el-input class="line" style="width: 100px" v-model.number="dataval[23]" />起，其中：项目经理查处<el-input
              class="line"
              style="width: 100px"
              v-model.number="dataval[24]"
            ></el-input
            >人次，每人次扣除7天费用；区域公司查处<el-input class="line" style="width: 100px" v-model.number="dataval[25]"></el-input
            >人次，每人次扣除15天费用；总公司或集团审计查处<el-input
              class="line"
              style="width: 100px"
              v-model.number="dataval[26]"
            />人次，每人次扣除30天费用；
          </td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[27]" /></td>
        </tr>
        <tr>
          <td class="center" rowspan="5">团队 考核</td>
          <td class="center" rowspan="3">员工 资质</td>
          <td class="left" colspan="6">
            1、本月不符合任职要求员工<el-input class="line" style="width: 100px" v-model.number="dataval[28]" />人次，每人次扣除500元；
          </td>
        ...
        <tr>
          <td class="left" colspan="6">
            2、合同生效之日起30天内，乙方未持中级消防设施操作员证<el-input
              class="line"
              style="width: 100px"
              v-model.number="dataval[30]"
            />人次，每人次扣5000元；
          </td>
        ...
        <tr>
          <td class="left" colspan="6">
            3、保安员60天内上岗证持证率【达到/未达到】[50%]以上，90天内上岗证持证率【达到/未达到】[80%]以上，未达标扣500元/月。
          </td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[32]" /></td>
        </tr>
        <tr>
          <td class="center" rowspan="2">团队 稳定性</td>
          <td class="left" colspan="6">1、乙方【是/否】连续两个月员工月度更换率超过50%，每出现1起扣除乙方5000元；</td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[33]" /></td>
        </tr>
        <tr>
          <td class="left" colspan="6">2、乙方【是/否】出现20%以上员工罢工、不在岗等未履行工作职责的，每出现1起扣除乙方服务费5000元。</td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[34]" /></td>
        </tr>
        <tr>
          <td class="center" rowspan="7">服务过程考核</td>
          <td class="center">安全基础 业务品质</td>
          <td class="left" colspan="6">
            本月度保安服务月度专项检查得分<el-input class="line" style="width: 100px" v-model.number="dataval[35]" />分，<br />
            1：检查结果＞85分（含），不扣减；，<br />
            2：检查结果80（含）-85分，每次扣除乙方服务费人民币1000元；，<br />
            3：检查结果75（含）-80分，每次扣除乙方服务费人民币3000元；，<br />
            4：检查结果＜75分，每次扣除乙方服务费人民币5000元；，<br />
            5：检查结果连续两个月＜70分，追加扣除乙方服务费人民币5000元。
          </td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[36]" /></td>
          <td class="center"><el-input class="line" v-model="dataval[37]" /></td>
        </tr>
        <tr>
          <td class="center" rowspan="6">员工违规 行为考核</td>
          <td class="left" colspan="6">1、乙方向甲方工作人员行贿的，扣除乙方一个月服务费作为违约金。</td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[38]" /></td>
          <td class="center"><el-input class="line" v-model="dataval[39]" /></td>
        </tr>
        <tr>
          <td class="left" colspan="6">2、乙方员工向甲方业主索要财物、搬弄是非或散布谣言的，每出现1次，每次扣除乙方服务费人民币2000元。</td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[40]" /></td>
          <td class="center"><el-input class="line" v-model="dataval[41]" /></td>
        </tr>
        <tr>
          <td class="left" colspan="6">
            3、乙方员工盗窃、私拿甲方业主或员工物品的；乙方员工恐吓、威胁甲方业主或员工，与甲方业主或员工发生肢体冲突的，扣除服务费5000元，从第2起按1.5倍增扣；
          </td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[42]" /></td>
          <td class="center"><el-input class="line" v-model="dataval[43]" /></td>
        </tr>
        <tr>
          <td class="left" colspan="6">4、乙方员工殴打甲方业主或员工的，致使造成轻微伤及以上的，扣除月度服务费的50%但不低于5万元/次。</td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[44]" /></td>
          <td class="center"><el-input class="line" v-model="dataval[45]" /></td>
        </tr>
        <tr>
          <td class="left" colspan="6">乙方员工酗酒上岗、睡岗、擅自脱岗/离岗，每出现一起，扣除乙方服务费人民币2000元；</td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[46]" /></td>
          <td class="center"><el-input class="line" v-model="dataval[47]" /></td>
        </tr>
        <tr>
          <td class="left" colspan="6">乙方员工在公共场所睡觉，聚岗聊天未造其他后果的。每出现一起，扣除乙方服务费人民币500元。</td>
          <td class="center"><el-input class="line" style="width: 100px" v-model.number="dataval[48]" /></td>
          <td class="center"><el-input class="line" v-model="dataval[49]" /></td>
        </tr>
        <tr>
          <td class="center" colspan="2">违约扣款合计</td>
          <td class="left" colspan="8">总计金额：<el-input class="line" style="width: 150px" v-model.number="dataval[50]" />元</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="left" colspan="8">
            (合同约定月度应支付服务费)<el-input class="line" style="width: 150px" v-model.number="dataval[51]" />
          </td>
        </tr>
        <tr>
          <td class="center" colspan="2">本月供方评价 违约扣款金额</td>
          <td class="left" colspan="8">
            （执行供方总体评价金额）<el-input class="line" style="width: 150px" v-model.number="dataval[52]" />
          </td>
        </tr>
        <tr>
          <td class="center" colspan="2">本月合同实付 含税金额</td>
          <td class="left" colspan="8">
            （月服务费标准减去供方总体评价金额）<el-input class="line" style="width: 150px" v-model.number="dataval[53]" />
          </td>
        </tr>
        <tr>
          ...
          <td class="left" colspan="8">
            (（本月合同实付含税金额/1.06）
            <el-input class="line" style="width: 150px" v-model.number="dataval[54]" />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="left" colspan="10">
            备注： <br />考核以《安保服务外包合同》、《服务质量考核细则》及其他相关附件为依据。<br />
            1、本表格为受控文件，根据需要可以增加行，不能更改布局、填写内容和格式。<br />
            2、检查时采用纸质填写，甲乙双方签字确认后复印一式三份，一份交乙方作为结算依据，一份交服务中心出纳作为核对依据，一份（原件）由项目安全岗保存。
          </td>
        </tr>
      </tbody>
    </table>
...
export default {
  ...
  computed: {
    ...
    val1() {
      return this.dataval[0] && parseInt(this.dataval[0]) < 90 ? (90 - parseInt(this.dataval[0])) * 500 : 0;
    },
    val3() {
      return this.dataval[2] && parseInt(this.dataval[2]) < 85 ? (85 - parseInt(this.dataval[2])) * 500 : 0;
    },
  },
  methods: {
      ...
      this.$http.get("/StartEvaluate/GetMonthEvalContent?groupId=" + this.groupId).then((res) => {
        if (res.status == 200) {
          ...
          if (res.data.result.length > 0) {
            let start =
              res.data.result[55].indexOf("T") > -1
                ? res.data.result[55].substring(0, res.data.result[55].indexOf("T")).split("-")
                : res.data.result[55].split("-");
            let end =
              res.data.result[56].indexOf("T") > -1
                ? res.data.result[56].substring(0, res.data.result[56].indexOf("T")).split("-")
                : res.data.result[56].split("-");
            this.value1 = [
    ...
    submit() {
      ...
      if (isOk) {
        this.$confirm("确定提交吗?", "提示", {
          ...
          this.dataval[55] = this.value1[0];
          this.dataval[56] = this.value1[1];
          let obj = {
            id: this.groupId,
            startTime: this.value1[0],
            endTime: this.value1[1],
            defaultdeductionTotal: this.dataval[50], //违约扣款合计
            payableTaxcontainingAmount: this.dataval[51], //本月合同应付含税金额
            defaultDeduction: this.dataval[52], //本月合同应付含税金额
            actualTaxcontainingAmount: this.dataval[53], //本月合同实付含税金额
            exclusiveOfTax: this.dataval[54], //本月合同实付不含税金额
