    ...
    <el-row id="page_main">
      <el-col :span="24">
        <el-form label-position="right" label-width="120px" :model="formSearch" size="small" class="border p-2 mt-2">
          <el-row :gutter="12">
            ...
            <el-col :span="3">
              ...
              <el-select v-model="limit" @change="changeLimit">
                <el-option label="权限" value=""></el-option>
                <el-option label="我参与的" value="IsGrade"></el-option>
                <el-option label="我发起的" value="IsStart"></el-option>
              </el-select>
              <!-- </el-form-item> -->
            </el-col>
            <el-col :span="3">
        ...
        >
          ...
          <el-table-column label="评价主体" align="center" width="180">
            <template slot-scope="scope">
          ...
          <el-table-column label="评审状态" align="center" width="100">
            <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    changeLimit(val) {
      this.formSearch.IsGrade = null;
      this.formSearch.IsStart = null;
      if (val == "IsGrade") {
        this.formSearch.IsGrade = true;
      } else if (val == "IsStart") {
        this.formSearch.IsStart = true;
      }
    },
    loadEvalMainForm() {
