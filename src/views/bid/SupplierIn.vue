              ...
              <el-table-column label="操作" align="center" width="100" fixed="right">
                <template slot-scope="scope">
                  <div>
                    ...
                    <i title="编辑" style="margin: 0 10px" v-if="scope.row.canEdit" class="el-icon-edit" @click="edit(scope.row)"></i>
...
export default {
  ...
  methods: {
    ...
    GetPlanRequireList() {
      ...
      this.loading = true;
      this.$http
        .get("/ModeMasterAppServices/GetSupplierMasterList", { params: obj })
        .then((res) => {
          if (res.data) {
