      ...
      <div style="margin-top: 10px">
        <el-row>
          ...
          >
            ...
            <el-table-column label="打款金额" width="110" prop="confirmMoney" align="center"></el-table-column>
          </el-table>
        </el-row>
      </div>
...
export default {
  ...
  methods: {
    ...
    GetLiandoSupplierDeposit06() {
      this.$http
        .get("/LiandoSupplierIn/GetLiandoSupplierDeposit06_CollectMoneyPage", { params: { planId: this.planId, masterId: this.masterId } })
        .then((res) => {
    ...
    GetNewLogList_CollectMoney() {
      this.$http
        .get("/WorkFlowStart/GetNewLogList_CollectMoney", { params: { planId: this.planId, masterId: this.masterId } })
        .then((res) => {
    ...
    omsubmit() {
      if (!this.remark) {
        ...
        this.$confirm("确认要通过审批吗?", "提示", {
          ...
          this.loading = true;
          this.$http.post("/WorkFlowStart/WF_Process_CollectMoney_Run", obj).then((res) => {
