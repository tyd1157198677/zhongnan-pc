  ...
  <el-main>
    <el-row id="page_main">
      ...
      <el-col :span="20" style="margin-bottom: 50px">
        ...
        <el-form :model="form" :rules="rules" ref="form" size="small" :inline="true" label-width="220px" class="mt-2">
          <div class="fromborder">
            ...
            <el-form-item label="供方考察日期" prop="supplierInvesDate">
              <el-date-picker type="date" v-model="form.supplierInvesDate" value-format="yyyy-MM-dd" placeholder="选择日期">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="图纸技术条件提供日期" prop="dwgFileDate">
              <el-date-picker type="date" v-model="form.dwgFileDate" value-format="yyyy-MM-dd" placeholder="选择日期"> </el-date-picker>
            </el-form-item>
            <el-form-item label="清单编制、招采文件完成日期" prop="listEditDate">
              <el-date-picker type="date" v-model="form.listEditDate" value-format="yyyy-MM-dd" placeholder="选择日期"> </el-date-picker>
            </el-form-item>
            <el-form-item label="计划发标时间" prop="bidSendDate">
              <el-date-picker type="datetime" v-model="form.bidSendDate" value-format="yyyy-MM-dd HH:mm" placeholder="选择时间">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="计划开标时间" prop="bidOpenDate">
              <el-date-picker type="datetime" v-model="form.bidOpenDate" value-format="yyyy-MM-dd HH:mm" placeholder="选择时间">
              </el-date-picker>
            </el-form-item>
