  ...
  <el-main>
    <el-row id="page_main">
      ...
      <el-col :span="20" style="margin-bottom: 50px">
        ...
        <el-row>
          <div class="float-right mt-2" style="margin-bottom: 10px">
            ...
            >
              <el-table-column label="评标类型" prop="bidPersonExam" align="center">
                <template slot-scope="scope">
                  <el-select v-model="scope.row.bidPersonExam" placeholder="全部">
              ...
              <el-table-column label="角色">
                <template slot-scope="scope">
                  <el-select v-model="scope.row.bidRole" placeholder="全部">
...
export default {
  name: "Step2",
  components: { PlanMenu, UserSelect },
  inject: ["reload"],
  data() {
    return {
      loading: false,
