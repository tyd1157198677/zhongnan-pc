  ...
  <el-main>
    <el-row id="page_main">
      ...
      <el-col :span="20" style="margin-bottom: 50px">
        ...
        <el-form :model="form" :rules="rules" ref="form" label-width="130px" :inline="true" class="mt-2">
          <div class="fromborder">
            <el-form-item label="项目名称">
              <el-input v-model="form.projectName" :disabled="true"></el-input>
            </el-form-item>
            <el-form-item label="直接委托原因" prop="cause">
...
export default {
  ...
  methods: {
    ...
    getCause() {
      this.$api.BidModeMasterOther.GetCauseZhiWei().then((res) => {
        this.causeFrom = res;
      });
    ...
    onSubmit() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          this.$api.BidModeMasterOther.InsertOrUpdateBidModeMasterZhiWei(this.form)
            .then((res) => {
              if (res.success) {
