...
export default {
  ...
  methods: {
    ...
    GetPurchaseLxSupplierList3001() {
      this.$http.get("/PurchaseModeLx/GetPurchaseLxSupplierList3001", { params: { bidModeId: this.id } }).then((res) => {
    ...
    GetPurchaseModeLx3001() {
      this.$http.get("/PurchaseModeLx/GetPurchaseModeLx3001", { params: { bidModeId: this.id } }).then((res) => {
        this.form1 = res.data;
