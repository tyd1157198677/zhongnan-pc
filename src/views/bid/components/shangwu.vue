...
<template>
  <div style="margin-top:10px">
    ...
    <el-card class="box-card" style="margin-top: 30px;">
      ...
      <div class="text item">
        ...
        ></el-table-column> -->
          ...
          <el-table-column label="商务标书" v-if="showbiao" align="center" width="120">
            <template slot-scope="scope">
              ...
              <span
                ...
                title="下载商务标书"
                @click="downLoad(scope.row.businessFileId)"
              ></span>
            </template>
          </el-table-column>
          ...
          <el-table-column label="投标总金额" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.isLockBusinessFilePath" class="el-icon-lock"></span>
              <span v-else>{{ scope.row.amount }}</span>
            </template>
          </el-table-column>
          <!-- <el-table-column label="不含税总金额" align="center">
            <template slot-scope="scope">
              <span v-if="scope.row.isLockBusinessFilePath" class="el-icon-lock"></span>
    ...
    <el-card class="box-card" style="margin-top: 30px;">
      ...
      <div class="text item">
        ...
        >
          ...
          <el-table-column align="left" label="供应商名称" min-width="260" show-overflow-tooltip fixed="left">
            <template slot-scope="scope">
    ...
    <!--<el-table-column label="标段" align="center" prop="sectionName"></el-table-column>-->
    <!--<el-table-column label="类型" align="center" prop="masterType"></el-table-column>-->
    <!--&lt;!&ndash; <el-table-column label="技术标" align="center" prop="techStatus"></el-table-column> &ndash;&gt;-->
    <!--<el-table-column label="商务标" align="center" prop="businessStatus"></el-table-column>-->
    <!--<el-table-column label="计划开标时间" align="center" prop="openDate">-->
    <!--<template slot-scope="scope">-->
    <!--<span>{{ parseTime(scope.row.openDate, "yyyy-MM-dd hh:mm") }}</span>-->
...
export default {
  ...
  methods: {
    ...
    GetSupplierInPageShow1() {
      this.$http.get("/OpenBidCenter/GetOpenBusinessPageMain002", { params: { bidModeId: this.id } }).then(res => {
    ...
    GetSupplierInPageShow2() {
      this.$http
        .get("/OpenBidCenter/GetOpenBusinessPageMain002", { params: { bidModeId: this.id, sectionId: this.sectionId } })
        .then(res => {
          this.supplierList = res.data.sectionDropDownList;
          // this.activeName2 = res.data.sectionDropDownList[0].value;
          this.pageMessage = res.data.pageMessage;
    ...
    GetBidCenterDetailShow01(row) {
      ...
      this.$http
        .get("/OpenBidCenter/GetBusinessDetailShow002", {
          params: {
            rowId: row.rowId,
            bidModeId: this.id,
    ...
    GetSupplierInPageShow() {
      this.$http.get("/BidOpen/GetOpenBusinessShowPage", { params: { bidModeId: this.id, sectionId: this.activeName2 } }).then(res => {
        this.tableData = res.data.supplierList;
        this.pageMessage = res.data.pageMessage;
      });
    },
    GetHistoryPrice38() {
      this.$http.get("/ExplainCenter/GetHistoryPrice38", { params: { bidModeId: this.id, sectionId: this.activeName2 } }).then(res => {
    ...
    GetExplainHistory() {
      ...
      this.$http.get("/BidExplain/GetOpenBusinessExplainPageShow", { params: obj }).then(res => {
