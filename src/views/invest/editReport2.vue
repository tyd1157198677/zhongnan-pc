<template>
  <div style="margin:0px auto 10px;margin-bottom: 65px;width:90%;">
    <el-row>
      <el-col :span="23">
      <el-select v-model="supplierId" @change="change1">
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="考察主题信息" name="考察主题信息">
        <table class="layui-table el-table__body">
          <tbody>
            <tr>
              <td style="width: 20%" class="right">考察分类：</td>
              <td style="width: 30%">
                {{ form.supCateName }}
              </td>
              <td style="width: 20%" class="right">考察主题：</td>
              <td style="width: 30%">
                {{ form.masterName }}
              </td>
            </tr>
      ...
      <el-tab-pane :label="this.dropDownGroup.moduleName1" :name="this.dropDownGroup.moduleName1" v-if="this.dropDownGroup.moduleName1">
        <el-form ref="form11" :inline="true" label-width="200px" :model="form11" :rules="rules" class="m-3">
          <el-row v-for="(item, index) in data1" :key="item.id">
            <el-col>
      ...
      <el-tab-pane :label="this.dropDownGroup.moduleName2" :name="this.dropDownGroup.moduleName2" v-if="this.dropDownGroup.moduleName2">
        <el-form ref="form12" :inline="true" label-width="200px" :model="form12" :rules="rules" class="m-3">
          <el-row v-for="(item, index) in data2" :key="item.id">
            <el-col>
              <el-form-item :label="item.cateName" prop="cateName">
                <el-input v-model="item.cateValue"></el-input>
              </el-form-item>
      ...
      <el-tab-pane :label="this.dropDownGroup.moduleName3" :name="this.dropDownGroup.moduleName3" v-if="this.dropDownGroup.moduleName3">
        <el-form ref="form13" :inline="true" label-width="200px" :model="form13" :rules="rules" class="m-3">
          <el-row v-for="(item, index) in data3" :key="item.id">
            <el-col>
              <el-form-item :label="item.cateName" prop="cateName">
                <el-input v-model="item.cateValue"></el-input>
              </el-form-item>
      ...
      <el-tab-pane label="业绩复核" name="业绩复核">
      ...
      <el-tab-pane label="考察照片" name="考察照片">
      ...
      <el-tab-pane label="资质评估结果" name="资质评估结果">
        <el-table
          empty-text="暂无数据"
          stripe
          border
      ...
      <el-tab-pane label="考察打分结果" name="考察打分结果">
        <div class="table-top-title" style="margin-bottom: 10px">
          <i>{{ this.dropDownGroup.scoreMessage }}</i>
          <i style="float: right" v-if="this.dropDownGroup.finalScore">最终得分：{{ this.dropDownGroup.finalScore }}</i>
        </div>
        <el-table
          empty-text="暂无数据"
          stripe
      ...
      <el-tab-pane label="考察人员打分信息" name="考察人员打分信息">
        <el-table
          empty-text="暂无数据"
          stripe
          border
      ...
      <el-tab-pane label="提交考察结果" name="提交考察结果">
        <div class="table-top-title" style="margin-bottom: 10px" v-if="this.dropDownGroup.submitTabMessage">
          提醒：<i>{{ this.dropDownGroup.submitTabMessage }}</i>
        </div>
        <el-form ref="form" :inline="true" label-width="130px" :model="form" class="m-3">
          ...
          <el-button type="primary" size="small" @click="SaveSupplierResult" style="float: right;" v-if="this.dropDownGroup.canSubmitReport"
            >提交考察结果</el-button
          >
        </el-form>
      </el-tab-pane>
      ...
      <el-form ref="form3" :inline="true" label-width="100px" :model="form3" class="m-3">
        ...
        <el-row>
          <el-form-item label="图片描述：" prop="AttachDesc">
            <el-input type="textarea" v-model="AttachDesc"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    jumpSuppInfo(row) {
      console.log(row);
      this.flag3 = true;
      this.$api.invest.GetPersonSupplierResult({ personId: row.personId, supGuid: this.supplierId }).then(res => {
