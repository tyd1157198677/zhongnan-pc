<template>
  <div style="margin:0px auto 10px;margin-bottom: 65px;width:90%;">
    <div style="text-align:right;margin-right:13px">
      <span class="headername">监理-供应商考察报告</span>
    ...
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">{{ formList.length + 2 }}.监理项目招标考评模块</div>
      <kaocha :moudleType="moudleType"></kaocha>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
...
import kaocha from "../comp/kaocha";
