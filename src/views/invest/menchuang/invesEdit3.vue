<template>
    <div>
      ...
      >
        ...
        <el-table-column prop="column2" label="加工厂规模（占地面积及厂房面积）"> </el-table-column>
        <el-table-column prop="column3" label="主营产品（塑钢、铝合金、系统窗、玻璃）" > </el-table-column>
        <el-table-column prop="column4" label="门窗年度产量" > </el-table-column>
        <el-table-column prop="column5" label="塑钢/铝合金业务占比（塑钢/铝合金几条生产线、塑钢/铝合金占%）" > </el-table-column>
      ...
      <el-dialog :visible.sync="flag" :title="dailogTitle" width="50%">
        <el-form
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="主营产品" prop="column3">
                <el-input v-model="formgongfang.column3" maxlength="11"
                      ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="门窗上一年度产量" prop="column4">
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="塑钢业务占比（塑钢占%" prop="column5">
