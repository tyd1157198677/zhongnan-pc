<template>
    <div>
      ...
      >
        ...
        <el-table-column prop="column1" label="详细地址"></el-table-column>
        <el-table-column prop="column2" label="加工厂规模（占地面积及建筑面积）"> </el-table-column>
        <el-table-column prop="column3" label="单元体幕墙生产线（几条）" > </el-table-column>
        <el-table-column prop="column4" label="玻璃合片生产线（有、无）" > </el-table-column>
        <el-table-column prop="column5" label="门窗生产线（塑钢、铝合金）" > </el-table-column>
      ...
      <el-dialog :visible.sync="flag" :title="dailogTitle" width="60%">
        <el-form
          ref="formgongfang"
          :inline="true"
          label-width="100px"
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="详细地址" prop="column1">
                <el-input v-model="formgongfang.column1"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="加工厂规模" prop="column2">
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="单元体幕墙生产线（几条）" prop="column3">
                <el-input v-model="formgongfang.column3" maxlength="11"
                      ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="玻璃合片生产线（有、无）" prop="column4">
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="门窗生产线（塑钢、铝合金）" prop="column5">
