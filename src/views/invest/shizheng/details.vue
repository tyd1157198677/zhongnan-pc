<template>
  <div style="margin:0px auto 10px;margin-bottom: 65px;width:90%;">
    <div style="display:flex;justify-content:space-between;padding:10px">
      <span class="headername">市政专业-供应商考察报告</span>
      <div>
    ...
    <div ref="print">
      ...
      <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
        <div class="table-top-title" style="margin-bottom: 10px">14.考察附件（考察照片及考察报告）</div>
        <edit33></edit33>
      </el-row>
      ...
      this.$http
        .get("/InvesLianDoFromNew/GetModuleDynamicFormAll", {
          params: {
            ...
            dynamicModule: "供方考察_市政",
          },
        })
        .then(res => {
          console.log("供方考察_市政", res);
