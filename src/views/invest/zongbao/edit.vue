<template>
  <div style="margin:0px auto 10px;margin-bottom: 65px;width:90%;">
    <div style="text-align:right;margin-right:13px">
      <span class="headername">总包专业-供应商考察报告</span>
    ...
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">2.接洽人员情况</div>
      <edit2></edit2>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">3.承接模式及劳务分包模式</div>
      <improtantDynamic :type="1"></improtantDynamic>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">4.公司基本情况</div>
      <improtantDynamic :type="5"></improtantDynamic>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">5.实际承包人基本情况</div>
      <improtantDynamic :type="6"></improtantDynamic>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">6.考察项目情况</div>
      <improtantDynamic :type="7"></improtantDynamic>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">7.拟派项目经理或驻场项目负责人</div>
      <!-- <edit4 pagename="供方考察_总包"></edit4> -->
      <improtantDynamic :type="10"></improtantDynamic>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">8.资金情况</div>
      <improtantDynamic :type="8"></improtantDynamic>
    </el-row>
    <!-- <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">9.背调结果</div>
      <bei-jing :type="3"></bei-jing>
    </el-row> -->
    <!--    <el-row>-->
    <!--      <div>-->
    <!--        <report></report>-->
    ...
    <!--    </el-row>-->
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">9.综合评价</div>
      <improtantDynamic :type="9"></improtantDynamic>
    </el-row>
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">10.考察附件（考察照片及考察报告）</div>
      <edit3></edit3>
    </el-row>
...
// import edit2 from "../comp/invesEdit2";
import edit3 from "../comp/invesEdit3";
import edit4 from "../comp/invesEdit4";
import edit5 from "../comp/invesEdit5";
import improtantDynamic from "../comp/improtantDynamic";
import report from "../comp/invesEdit5_1";
import BeiJing from "../comp/beiJing.vue";
