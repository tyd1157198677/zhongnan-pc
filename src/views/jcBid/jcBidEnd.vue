      ...
      <el-card>
        <el-form label-position="right" :model="formSearch" size="small">
          <el-row :gutter="12">
            ...
            <el-col :span="3">
              ...
              <el-input v-model="formSearch.planName" placeholder="供方名称" clearable></el-input>
              <!-- </el-form-item> -->
            </el-col>
            <!-- <el-col :span="3">
            ...
            <el-col :span="3">
              <!-- <el-form-item label="需求部门："> -->
              <el-select v-model="formSearch.depName" placeholder="所属组织" @change="selectChange">
                <el-option label="所属组织" value=""> </el-option>
                <el-option v-for="item in depNames" :key="item.value" :label="item.text" :value="item.value"> </el-option>
              </el-select>
              <!-- </el-form-item> -->
            </el-col>
            <el-col :span="3">
              <!-- <el-form-item label="需求部门："> -->
              <el-select v-model="formSearch.depName" placeholder="协议上传状态" @change="selectChange">
                <el-option label="协议上传状态" value=""> </el-option>
                <el-option v-for="item in depNames" :key="item.value" :label="item.text" :value="item.value"> </el-option>
              </el-select>
              <!-- </el-form-item> -->
            </el-col>
        ...
        <div class="mt-2">
          ...
          >
            ...
            <el-table-column label="专业" align="center" width="120px" fixed>
              <template slot-scope="scope">
                <span>{{ scope.row.zhuanye }}</span>
              </template>
            </el-table-column>
            <el-table-column label="层级" align="center" width="120px" fixed>
              <template slot-scope="scope">
            ...
            <el-table-column label="所属组织" width="120" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.purchaseType }}</span>
              </template>
            </el-table-column>
            <el-table-column label="供方名称" min-width="250" align="left">
              <template slot-scope="scope">
                <span>{{ scope.row.bidCateName }}</span>
              </template>
            </el-table-column>
            <el-table-column label="定标日期" width="200" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column label="集采协议" width="120" align="center">
              <template slot-scope="scope">
                <span v-if="scope.row.planStatus === '未上传'" style="color: red">{{ scope.row.planStatus }}</span>
            ...
            <el-table-column label="操作" align="center" width="100" fixed="right">
              <template slot-scope="scope">
                <div>
                  <i style="margin-right: 10px" title="查看" class="el-icon-search" @click="del(scope.row.id)"></i>
                </div>
              </template>
            </el-table-column>
          </el-table>
