<template>
  <div class="">
    <el-main>
      <div class="pub">广东东鹏陶瓷股份有限公司（专业：陶瓷）-品牌主体信息</div>
      <table class="layui-table el-table__body">
        <tbody>
          <tr>
            <td class="right">协议或合同名称：</td>
            <td>{{ form1.reason }}</td>
            <td class="right">协议或合同编号：</td>
            <td>{{ form1.bidEndDate }}</td>
          </tr>
          <tr>
            <td class="right">协议有效期-开始：</td>
            <td>{{ form1.reason }}</td>
            <td class="right">协议有效期-结束：</td>
            <td>{{ form1.bidEndDate }}</td>
          </tr>
          <tr>
            <td class="right">层级：</td>
            <td>{{ form1.reason }}</td>
            <td class="right">所属组织：</td>
            <td>{{ form1.bidEndDate }}</td>
          </tr>
          <tr>
            <td class="right">协议类型：</td>
            <td>{{ form1.reason }}</td>
            <td class="right">价格形成方式：</td>
            <td>{{ form1.bidEndDate }}</td>
          </tr>
          <tr>
            <td class="right">品牌名称：</td>
            <td>{{ form1.reason }}</td>
            <td class="right">集采协议附件：</td>
            <td><i class="el-icon-download ml-2" title="下载文件"></i></td>
          </tr>
          <tr>
            <td class="right">相关说明：</td>
            <td colspan="3">{{ form1.reason }}</td>
          </tr>
        </tbody>
      </table>
      <div class="pub">联系人信息</div>
      <div>
        <el-row>
          <div class="sts"></div>
          <el-table empty-text="无符合条件的记录" stripe border element-loading-text="请稍候,数据正在加载中..." :data="fileslist">
            ...
            <el-table-column label="手机" prop="showji" align="center"> </el-table-column>
            <el-table-column label="座机" prop="zuoji" align="center"> </el-table-column>
      ...
      <div class="pub">代理商信息</div>
      <div>
        <el-row style="margin-bottom:50px">
          <div class="sts"></div>
          <el-table empty-text="无符合条件的记录" stripe border element-loading-text="请稍候,数据正在加载中..." :data="fileslist">
            <el-table-column type="index" width="90" label="序号" align="center"> </el-table-column>
            <el-table-column label="代理商名称" prop="xiungming"> </el-table-column>
            <el-table-column label="负责城市" prop="showji" align="center" width="120"> </el-table-column>
            <el-table-column label="联系人信息" align="center">
              <el-table-column label="联系人姓名" prop="zuoji" align="center"></el-table-column>
              <el-table-column label="联系人电话" prop="youxiang" align="center"> </el-table-column>
              <el-table-column label="职位" prop="zhiwu" align="center"> </el-table-column>
            </el-table-column>
            <!-- <el-table-column label="上传日期" prop="creationTime" align="center" width="150">
              <template slot-scope="scope">
                <span>{{ parseTime(scope.row.creationTime, "yyyy-MM-dd") }}</span>
            ...
            <el-table-column label="操作" width="80" align="center">
              <template slot-scope="scope">
                <i class="el-icon-delete" title="删除" @click="onDownload(scope.row.id)"></i>
              </template>
            </el-table-column>
          </el-table>
        </el-row>
