...
<template>
    <div>
      ...
      >
        ...
        <el-table-column prop="column3" label="职务" > </el-table-column>
        <el-table-column prop="column4" label="施工时间" > </el-table-column>
        <el-table-column prop="column5" label="工程概况" > </el-table-column>
        <el-table-column prop="column6" label="幕墙类型" > </el-table-column>
      ...
      <el-dialog :visible.sync="flag" :title="dailogTitle" width="50%">
        <el-form
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="职务" prop="column3">
                <el-input v-model="formgongfang.column3" maxlength="11"
                      ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="施工时间" prop="column4">
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="工程概况" prop="column5">
                <el-input v-model="formgongfang.column5" maxlength="11"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="幕墙类型" prop="column5">
