<template>
    <div>
      ...
      >
        ...
        <el-table-column prop="column1" label="加工厂名称"></el-table-column>
        <el-table-column prop="column2" label="地址"> </el-table-column>
        <el-table-column prop="column3" label="加工厂规模（占地面积及建筑面积）" > </el-table-column>
        <el-table-column prop="column4" label="加工产品" > </el-table-column>
        <el-table-column prop="column5" label="龙骨、石材、铝板、门窗、玻璃、装饰面年度产量" > </el-table-column>
        <el-table-column prop="column6" label="备注（自有、外协）" > </el-table-column>
      ...
      <el-dialog :visible.sync="flag" :title="dailogTitle" width="50%">
        <el-form
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="加工厂名称" prop="column1">
                <el-input v-model="formgongfang.column1"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="地址" prop="column2">
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="加工厂规模" prop="column3">
                <el-input v-model="formgongfang.column3" maxlength="11"
                      ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="加工产品" prop="column4">
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="年度产量" prop="column5">
                <el-input v-model="formgongfang.column5" maxlength="11"
                      ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="备注" prop="column6">
                <el-input v-model="formgongfang.column6"  type="email"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
export default {
    ...
    methods: {
      ...
      saveadd(){
        ...
        if (valid) {
          this.formgongfang.tableMajorType = '加工厂情况'
