<template>
  <div style="margin:0px auto 10px;margin-bottom: 65px;width:90%;">
    <div style="text-align:right;margin-right:13px">
      <span class="headername">门窗专业-资格预审表</span>
    ...
    <el-row class="pt-3 pl-3 pr-3 mx-auto mh">
      <div class="table-top-title" style="margin-bottom: 10px">门窗加工厂情况</div>
      <edit3></edit3>
    </el-row>
...
import projectResults from "@/views/quality/components/projectResultsmenchuang";
      ...
      this.$http
        .get("/InvesLianDoFromNew/GetModuleDynamicFormAll", {
          params: {
            ...
            dynamicModule: "资格预审_门窗",
          },
        })
        .then(res => {
          console.log("资格预审_门窗", res);
