<template>
    <div>
      ...
      >
        ...
        <el-table-column prop="column3" label="主营产品（塑钢、铝合金门窗）" > </el-table-column>
        <el-table-column prop="column4" label="门窗上一年度产量" > </el-table-column>
        <el-table-column prop="column5" label="塑钢业务占比（塑钢占%）" > </el-table-column>
