...
<template>
  <div class="">
    ...
    <el-table :data="companyYeJi" stripe border v-loading="loading">
      ...
      <el-table-column align="center" label="门窗类型" prop="projectAddress"> </el-table-column>
      <el-table-column align="center" label="生产厂家" prop="projectAddress"> </el-table-column>
      <el-table-column align="center" label="门窗面积（m2）" prop="formatAndMes" width="130"> </el-table-column>
