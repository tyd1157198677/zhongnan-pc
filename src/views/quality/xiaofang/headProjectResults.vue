...
<template>
    <div>
      ...
      >
        ...
        <el-table-column prop="column1" label="建设单位"></el-table-column>
        <el-table-column prop="column2" label="项目名称"> </el-table-column>
        <el-table-column prop="column3" label="消防承接范围"> </el-table-column>
        <el-table-column prop="column4" label="职务" > </el-table-column>
        <el-table-column prop="column5" label="施工时间" > </el-table-column>
        <el-table-column prop="column6" label="工程规模" > </el-table-column>
        <el-table-column prop="column7" label="合同金额" > </el-table-column>
        <el-table-column prop="column8" label="工程质量" > </el-table-column>
      ...
      <el-dialog :visible.sync="flag" :title="dailogTitle" width="50%">
        <el-form
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="建设单位" prop="column1">
                <el-input v-model="formgongfang.column1"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="项目名称" prop="column2">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="消防承接范围" prop="column3">
                <el-input v-model="formgongfang.column3"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="职务" prop="column4">
                <el-input v-model="formgongfang.column4" maxlength="11"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row> 
            <el-col :span="12">
              <el-form-item label="施工时间" prop="column5">
                <el-input v-model="formgongfang.column5"  type="email"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="工程规模" prop="column6">
          ...
          <el-row> 
            <el-col :span="12">
              <el-form-item label="合同金额" prop="column7">
                <el-input v-model="formgongfang.column7" maxlength="11"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="工程质量" prop="column8">
                <el-input v-model="formgongfang.column8" maxlength="11"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
const TABLE_MAJOR_TYPE = '拟派驻场项目负责人有代表性的工程业绩'

export default {
    name:'headProjectResults',
    props:['type'],
    data() {
        return {
          isEdit: 0, // 1:编辑，2：详情
