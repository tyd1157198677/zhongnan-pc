    ...
    <el-row id="page_main">
      <el-col :span="24">
        ...
        >
          ...
          <el-table-column prop="orgName" align="center" label="公司名称" width="350px"> </el-table-column>
          <el-table-column prop="projectName" align="center" label="项目名称" width="300px"> </el-table-column>
          <el-table-column prop="noStartCount" align="center" label="招标进度">
...
export default {
  ...
  methods: {
    loadQueryForm() {
      this.loading = true;
      this.$api.supIn.GetProjectSupplierInStatTree(this.formSearch).then((res) => {
        this.loading = false;
        this.tableData = res;
      });
    },
