  ...
  <el-main>
    <el-row id="page_main">
      <el-tabs v-model="activeName" type="border-card">
        <el-tab-pane label="招标分工" name="first">
          <el-col :span="24">
                ...
                <el-col :span="6">
                  <el-form-item label="招标层级：">
                    <el-select v-model="formSearch.BidLevel">
                      <el-option
                        v-for="item in table1.bidLevelDropDown"
                        :key="item.value"
                        :label="item.text"
                        :value="item.value"
                      ></el-option>
        ...
        <el-tab-pane label="入围分工" name="second">
          <el-col :span="24">
            <el-form label-position="right" label-width="120px" :model="formSearch" size="small" class="border p-2 mt-2">
              <el-row type="flex" justify="end">
                <el-col :span="6">
            ...
            <el-row class="float-right mb-2 mt-2">
              <el-col :span="24">
                <el-button type="primary" size="small" @click="loadQueryForm2">搜索</el-button>
              </el-col>
            </el-row>
            <el-table
              empty-text="无符合条件的记录"
...
export default {
  ...
  methods: {
    loadQueryForm() {
      this.loading = true;
      this.$api.supIn.GetBidDivideStat(this.formSearch).then((res) => {
        this.tableData = res;
        this.loading = false;
        this.loadQueryForm2();
      });
