  ...
  <el-main>
    <el-row id="page_main">
      <div style="text-align:right;margin-bottom:40px">
        <div>
          <span class="headername">项目背调信息</span>
        </div>
      ...
      <div style="margin-top: 10px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="5">
                ...
                <el-input maxlength="250" v-else type="textarea" v-model="base.performance" placeholder="请填写"></el-input>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <el-dialog title="背调内容" :visible.sync="dialogVisible">
          ...
          <div style="margin-top:10px;margin-bottom:10px">
            <el-input v-model="base.itemValuestext" type="textarea" maxlength="1000"></el-input>
          </div>
        </el-dialog>
...
export default {
  ...
  methods: {
    ...
    jumpDetail(id) {
      this.$http
        .get("/BackGroundResultAppServices/GetBackGroundResultItemsById", {
          params: { id },
        })
        .then(res => {
          this.base = res.data;
