    ...
    <el-card>
      ...
      <el-form label-position="top" ref="neweditform" :model="neweditform" :rules="rules1">
        <el-row v-if="type == 1" :gutter="20">
          <el-col :span="12">
            <el-form-item label="供应商名称：" prop="comFullName">
              <el-input v-model="neweditform.comFullName" style="width:100%">
          ...
          <el-col :span="12">
            <el-form-item label="项目名称：">
              <el-input v-model="proJectName" @focus="subJectAdd">
                <el-button slot="append" icon="el-icon-search" @click="subJectAdd"></el-button>
              </el-input>
            </el-form-item>
          </el-col>
          <!-- <el-col :span="8">
            <el-form-item label="区域:">
              <el-input style="width:100%" v-model="neweditform.area" type="text" placeholder="请输入区域"></el-input>
            </el-form-item>
          </el-col> -->
          <el-col :span="12">
            <el-form-item label="黑名单开始日期:" prop="startDate">
              <el-date-picker
                style="width:100%"
          ...
          <el-col :span="12">
            <el-form-item label="所属专业：">
              <el-select
                v-if="neweditform.supType != '其他' && typeList.indexOf(neweditform.supType) > -1"
                v-model="neweditform.supType"
                style="width:100%"
              >
                <el-option v-for="item in typeList" :key="item" :label="item" :value="item"></el-option>
              </el-select>
              <el-input v-else v-model="neweditform.supType" placeholder="请输入专业"></el-input>
            </el-form-item>
          </el-col>
          <!-- <el-col :span="24">
            <el-form-item label="原因描述：">
              <el-input v-model="neweditform.desc" type="textarea" maxlength="150" placeholder="请输入原因描述"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="发生事件：">
              <el-input v-model="neweditform.incident" type="textarea" maxlength="150" placeholder="请输入发生事件"></el-input>
            </el-form-item>
          </el-col> -->
          <el-col :span="24">
            <el-form-item label="备注：">
              <el-input v-model="neweditform.remark" type="textarea" maxlength="150" placeholder="请输入备注"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row v-if="type == 2" style="margin-bottom:10px">
        ...
        <!--  <el-row>
          <el-col :span="8">
            <el-form-item label="黑名称结束日期：">
              <el-input style="width:200px" v-model="neweditform.endDate" :disabled="true" placeholder="永久"></el-input>
            </el-form-item>
          </el-col> -
           <table class="layui-table el-table__body">
            <tbody>
           ...
           <el-col :span="8">
            <el-form-item label="层级分类：">
              <el-select v-model="neweditform.cengji">
        ...
        <el-row v-if="isShowPerson">
          <div v-if="type == 1">
            <el-button style="float:right;margin-bottom:10px" type="primary" size="mini" @click="addpeo">添加人员</el-button>
          </div>
          <el-table empty-text="无符合条件的记录" stripe border element-loading-text="请稍候,数据正在加载中..." :data="tablelist">
            ...
            <el-table-column label="操作" width="80" align="center" v-if="type == 1">
              <template slot-scope="scope">
                <span class="el-icon-edit" @click="edit(scope.row)" style="margin-right:10px"></span>
                <i class="el-icon-delete" title="删除" @click="onDelete(scope.row.id, 1)"></i>
              </template>
            </el-table-column>
          </el-table>
        </el-row>
        <el-row v-if="type == 2" style="margin-top:10px">
        ...
        <el-row v-if="type == 1">
          <!-- <template slot-scope="scope"> -->
          <el-button @click="fujian" type="primary" size="small" style="margin-top:20px">上传附件</el-button>
          <span>
            只能上传图片、pdf、office文件，单个文件最大10M
          </span>
          <!-- </template> -->
        </el-row>
        <el-row style="margin-bottom:40px">
          <el-col :span="24" class="right" v-if="type == 1">
            <el-button size="small" @click="goback">取消</el-button>
            <el-button type="primary" size="small" @click="saveadd('neweditform')">保存信息</el-button>
          </el-col>
          <!--  v-if="type == 2 && neweditform.showAudit" -->
          <el-col :span="24" class="right" v-if="type == 2 && neweditform.showAudit">
  ...
  computed: {
    ...
    proJectName() {
      if (!this.neweditform.supBackProjectList) {
        ...
        return this.neweditform.supBackProjectList.length > 0 ? this.neweditform.supBackProjectList.map(v => v.projectName).toString() : "";
      }
    },
  },
  filters: {
