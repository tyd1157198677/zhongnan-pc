      ...
      <div style="margin-top: 10px">
        <el-row>
          <el-table empty-text="无符合条件的记录" stripe border element-loading-text="请稍候,数据正在加载中..." :data="tabledata">
            ...
            <el-table-column label="投标方" width="300" prop="comFullName" align="left"> </el-table-column>
            <el-table-column label="标段" width="120" prop="sectionName" align="center"> </el-table-column>
            <el-table-column label="回标状态" width="120" prop="backStatus" align="center"> </el-table-column>
            <el-table-column label="废标原因" prop="remark" align="center"> </el-table-column>
          </el-table>
        </el-row>
      </div>
...
export default {
  ...
  methods: {
    ...
    GetBidCancelAuditPageShow() {
      this.$http.get("/BidCancel/GetBidCancelAuditPageShow", { params: { bidCancelId: this.masterId } }).then((res) => {
    ...
    GetBidCancelList() {
      this.$http.get("/WflowApproveLogsAppServices/GetBidCancelList", { params: { MasterId: this.masterId } }).then((res) => {
