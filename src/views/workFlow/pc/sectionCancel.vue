      ...
      <div style="margin-top: 10px">
        <el-row>
          <el-table empty-text="无符合条件的记录" stripe border element-loading-text="请稍候,数据正在加载中..." :data="tabledata">
            ...
            <el-table-column label="标段名称" width="300" prop="sectionName" align="left"> </el-table-column>
            <el-table-column label="流标原因" prop="reason" align="center"> </el-table-column>
          </el-table>
        </el-row>
      </div>
...
export default {
  ...
  methods: {
    ...
    GetRunOffAudit() {
      this.$http.get("/BidRunOff/GetRunOffAudit", { params: { MasterId: this.masterId } }).then((res) => {
    ...
    GetSectionCancelList() {
      this.$http.get("/WflowApproveLogsAppServices/GetSectionCancelList", { params: { MasterId: this.masterId } }).then((res) => {
